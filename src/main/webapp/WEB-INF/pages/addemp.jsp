...
<body>
	...
	<div class="container">
		<form:form modelAttribute="employee" action="${pageContext.request.contextPath}/newemp" onSubmit="return validate();">
			<table class="table-condensed">
				<tr>
					<th><h1>New Internal user</h1></th>
				</tr>
				<tr>
				...
				<tr> 
					...
					<td><form:input class= "form-control" path="employeeName" name="first-name" id="first-name1" required="required"/></td>
					<td>
				...
				<tr>
					<td><b>Email</b></td>
					<td><form:input class= "form-control" path="employeeEmailId" name="email-address" id="email-address" required="required"/></td>
					<td>
				...
				<tr>
					...
					<td>
						<form:input class= "form-control" path="employeeUsername" maxlength="16" id="usernameip" required="required"/></td>
						<td>
				...
				<tr>
					...
					<td><form:select path="employeeDesignation">
				...
				<tr>
					<td><b>Salary</b></td>
					<td>
						<form:input type="number" min="5000" path="employeeSalary" maxlength="6"/>
					</td>
				</tr>
