...
<form:form  id="form" modelAttribute="newLoginPassword" action="${pageContext.request.contextPath}/saveNewPassword">
...
<tr>
<td/>
<td><input type="submit" value="Save" class="btn btn-default" name="Save" id="save"/></td>
</tr>
</table>
